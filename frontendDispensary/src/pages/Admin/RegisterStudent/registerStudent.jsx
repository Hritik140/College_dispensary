...
const RegisterStudent = (props) => {
    ...
    const handleSearch = async()=>{
        ...
        props.showLoader();
        await axios.get(`https://college-dispensary-pro.onrender.com/api/auth/get-student-by-roll/${searchStudent}`,{withCredentials:true}).then(resp=>{
            console.log(resp)
    ...
    const handleUpdateFunc = async()=>{
        ...
        await axios.put(`https://college-dispensary-pro.onrender.com/api/auth/update-student/${_id}`,student,{withCredentials:true}).then(resp=>{
            console.log(resp)
            toast.success(resp.data.message);
        }).catch(err => {
            toast.error(err?.response?.data?.error);
    ...
    const registerStudent = async()=>{
        ...
        props.showLoader();
        await axios.post('https://college-dispensary-pro.onrender.com/api/auth/registerStudentByStaff',studentDetail,{withCredentials:true}).then(response=>{
