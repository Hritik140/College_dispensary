...
const Report = (props) => {
    ...
    const fetchData = async () => {
        await axios.get(`https://college-dispensary-pro.onrender.com/api/medicine/search-by-name?name=${searchMedicineName}`).then((resp) => {
            console.log(resp)
    ...
    const handleOnSubmit = async () => {
        ...
        await axios.post(`https://college-dispensary-pro.onrender.com/api/history/add`,
