...
const ManageStaff = (props) => {
    ...
    const handleUpdate =async()=>{
        ...
        await axios.put(`https://college-dispensary-pro.onrender.com/api/auth/update-staff/${clickedStaff?._id}`,inputField,{withCredentials:true}).then(response=>{
    ...
    const handleAddStaff =async(e)=>{
        ...
        props.showLoader()
        await axios.post('https://college-dispensary-pro.onrender.com/api/auth/add-staff',inputField,{withCredentials:true}).then((resp)=>{
            console.log(resp)
    ...
    const handleDelete = async(id)=>{
        await axios.delete(`https://college-dispensary-pro.onrender.com/api/auth/delete-staff/${id}`,{withCredentials:true}).then((response)=>{
            filterOutData(id)
        }).catch(err => {
