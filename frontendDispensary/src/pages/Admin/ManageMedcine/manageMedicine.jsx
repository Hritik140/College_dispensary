...
const ManageMedicine = (props) => {
    ...
    const fetchData = async () => {
        props.showLoader();
        await axios.get(`https://college-dispensary-pro.onrender.com/api/medicine/search-by-name?name=${medicineSearch}`).then((resp) => {
            console.log(resp)
    ...
    const handleDelete = async(id)=>{
        props.showLoader();
        await axios.delete(`https://college-dispensary-pro.onrender.com/api/medicine/delete/${id}`,{withCredentials:true}).then((resp)=>{
