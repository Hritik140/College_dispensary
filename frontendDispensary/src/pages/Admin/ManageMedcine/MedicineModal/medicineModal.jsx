...
const MedicineModal = (props) => {
    ...
    const updateValue = async()=>{
        props.showLoader();
        await axios.put(`https://college-dispensary-pro.onrender.com/api/medicine/update/${props.clickedMedicine._id}`,medicine,{withCredentials:true}).then((resp)=>{
    ...
    const handleSubmit = async (e) => {
        ...
        props.showLoader()
        await axios.post('https://college-dispensary-pro.onrender.com/api/medicine/add', medicine, { withCredentials: true }).then((resp) => {
            window.location.reload();
        }).catch(err => {
            toast.error(err?.response?.data?.error)
