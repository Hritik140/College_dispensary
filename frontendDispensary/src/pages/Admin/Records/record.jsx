...
const Record = (props) => {
    ...
    const fetchData = async () => {
        props.showLoader()
        await axios.get(`https://college-dispensary-pro.onrender.com/api/history/get-history?month=${selectedMonth}&year=${selectedYear}`, { withCredentials: true }).then(response => {
    ...
    const handleClick = async()=>{
        ...
        props.showLoader()
        await axios.get(`https://college-dispensary-pro.onrender.com/api/history/get?roll=${studentRoll}`,{withCredentials:true}).then(resp=>{
            console.log(resp)
