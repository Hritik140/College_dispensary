...
const Facility = (props) => {
    ...
    const fetchData = async () => {
        props.showLoader();
        await axios.get('https://college-dispensary-pro.onrender.com/api/facility/get').then((resp) => {
    ...
    const handlDelete = async(id)=>{
        props.showLoader()
        await axios.delete(`https://college-dispensary-pro.onrender.com/api/facility/delete/${id}`,{withCredentials:true}).then((resp)=>{
            filterOutData(id)
        }).catch(err => {
            toast.error(err?.response?.data?.error)
