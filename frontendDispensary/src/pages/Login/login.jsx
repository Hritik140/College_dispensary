...
const Login = (props) => {
    ...
    const handleLogin = async () => {
        ...
        await axios.post('https://college-dispensary-pro.onrender.com/api/auth/login', loginField, { withCredentials: true }).then((response) => {
    ...
    const handleRegister = async () => {
        ...
        props.showLoader();
        await axios.post('https://college-dispensary-pro.onrender.com/api/auth/register', registerField).then(response => {
